...
LogWhatever.Controls.Chart.PopularDaysChart.prototype.draw = function (container, logName) {
...
LogWhatever.Controls.Chart.PopularDaysChart.prototype._getData = function (logName) {
	return $.get(LogWhatever.Configuration.VirtualDirectory + "api/charts/popular-days?logName=" + logName).error(function () {
		LogWhatever.Feedback.error("An error has occurred while retrieving data for the popular days chart. Please contact technical support.");
	});
};